...
/**
 * Created by GongDongdong on 2019/5/2.
 */

@Aspect
public class TestAnnoAspect {

    //    @Pointcut("execution(* com.gdd.androidaopdemo.MainActivity.test(..))")
    @Pointcut("execution(@com.gdd.tolittlepart.aop.TestAnnoTrace * *(..))")
...
//        Method method = signature.getMethod(); // 方法：public void com.gdd.androidaopdemo.MainActivity.test(android.view.View)
